            ...
            {animalTypes.data.map((animal: AnimalType, i: number) => (
              ...
              >
                <Link
                  ...
                  className="group relative block h-full overflow-hidden rounded-3xl border bg-card p-8 text-center shadow-clay transition-all hover:-translate-y-1.5 hover:shadow-clay-lg"
                >
